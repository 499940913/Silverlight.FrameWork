...
{
    public class AccordionCommandViewModel : INotifyPropertyChanged, IViewModel, IFrameworkElementViewModel, ISourceViewModel, ICommandViewModel, IAssemblyViewModel, ITextViewMolde
    {
        ...
        public AccordionCommandViewModel()
        {
            _items=new
            List<AccordionCommandViewModel>();
        }
        ...
        public void InitiViewModel(XElement element,IAppFrame mFrame)
        {
          ...
          //  assemblyLoader.SetVisible(true);
            ...
            foreach (var item in items)
            {
                ...
                accordionCommandViewModel.InitiViewModel(item, _frame);
                _items.Add(accordionCommandViewModel);
            }
        ...
        public string ImageSize
        {
            ...
            set
            {
                _imageSize = value;
                if (PropertyChanged != null)
                    PropertyChanged(this, new PropertyChangedEventArgs("ImageSize"));
            }
        }

        private readonly List<AccordionCommandViewModel> _items;
        public List<AccordionCommandViewModel> Children {
            get { return _items; }
        }
