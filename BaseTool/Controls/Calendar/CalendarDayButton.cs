...
namespace  BaseTool.Primitives
{
    ...
    [TemplateVisualState(Name = StateRegularDay, GroupName = GroupDay)]
    [TemplateVisualState(Name = StateToday, GroupName = GroupDay)]
    [TemplateVisualState(Name = StateNormalDay, GroupName = GroupBlackout)]
    [TemplateVisualState(Name = StateBlackoutDay, GroupName = GroupBlackout)]
    public sealed class CalendarDayButton : Button
    {
        ...
        /// <summary>
        /// Gets or sets the BaseTool.Calendar associated with this button.
        /// </summary>
        ...
        /// if one has not been created for the BaseTool.Primitives.CalendarButton;  otherwise, it
        ...
        protected override void OnMouseLeftButtonDown(MouseButtonEventArgs e)
        {
            ...
            var handler = CalendarDayButtonMouseDown;
            if (null != handler)
            {
                handler(this, e);
            }
        ...
        protected override void OnMouseLeftButtonUp(MouseButtonEventArgs e)
        {
            ...
            var handler = CalendarDayButtonMouseUp;
            if (null != handler)
            {
                handler(this, e);
            }
        ...
        /// BaseTool.Primitives.CalendarDayButton  that stays in Pressed state after MouseCapture is
        ...
        /// the case when you select a date in the BaseTool.DatePicker control), it will
        ...
        internal void ChangeVisualState(bool useTransitions)
        {
            ...
            // button is the focused element on the BaseTool.Calendar control).
