...
namespace BaseTool
{
    ...
    {
        /// <summary>
        /// Gets the BaseTool.Primitives.CalendarDayButton  instance that is associated with this
        /// CalendarDayButtonAutomationPeer.
        /// </summary>
        private Primitives.CalendarDayButton  OwningCalendarDayButton
        {
            get { return Owner as Primitives.CalendarDayButton; }
        }

        /// <summary>
        /// Gets the BaseTool.Calendar associated with the button.
        /// </summary>
        ...
        /// <summary>
        /// Gets the automation peer for the BaseTool.Calendar associated with the
        /// button.
        /// </summary>
        private IRawElementProviderSimple OwningCalendarAutomationPeer
        {
            get
            {
                ...
                if (calendar != null)
                {
                    var peer = CreatePeerForElement(calendar);
                    if (peer != null)
                    {
        ...
        /// <see cref="T:System.Windows.Automation.Peers.CalendarDayButtonAutomationPeer" />.
        /// </param>
        public CalendarDayButtonAutomationPeer(Primitives.CalendarDayButton   owner)
            : base(owner)
        {
        }
        ...
        /// <summary>
        /// Returns the control type for the BaseTool.Primitives.CalendarDayButton  that is
        ...
        {
            return Resources.CalendarAutomationPeer_DayButtonLocalizedControlType;
        }

        /// <summary>
        /// Returns the string that describes the functionality of the
        /// BaseTool.Primitives.CalendarDayButton  that is associated with this
        ...
        {
            var  button = OwningCalendarDayButton;
            if (button != null && button.DataContext != null && button.DataContext is DateTime)
            {
                var dataContext = (DateTime)OwningCalendarDayButton.DataContext;
                var info = DateTimeHelper.GetCurrentDateFormat();

                return !button.IsBlackout ?
                    dataContext.Date.ToString(info.LongDatePattern, info) :
                    string.Format(info, Resources.CalendarAutomationPeer_BlackoutDayHelpText, dataContext.Date.ToString(info.LongDatePattern, info));
            }
        ...
        /// <summary>
        /// Returns the name of the BaseTool.Primitives.CalendarDayButton  that is associated with
        ...
        /// <summary>
        /// Returns the text label of the BaseTool.Primitives.CalendarDayButton  that is associated
        ...
        /// <summary>
        /// Ensure selection of the BaseTool.Primitives.CalendarDayButton  is possible.
        /// </summary>
        /// <returns>
        /// A value indicating whether selection of the BaseTool.Primitives.CalendarDayButton  is
        /// possible.
        /// </returns>
        ...
        IRawElementProviderSimple[] ITableItemProvider.GetColumnHeaderItems()
        {
            ...
            {
                var headers = ((ITableProvider)CreatePeerForElement(calendar)).GetColumnHeaders();
                if (headers != null)
                {
