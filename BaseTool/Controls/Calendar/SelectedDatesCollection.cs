...
namespace  BaseTool
{
    ...
    public sealed class SelectedDatesCollection : ObservableCollection<DateTime>
    {
        ...
        public void AddRange(DateTime start, DateTime end)
        {
            ...
            {
                // If BaseTool.CalendarSelectionMode.SingleRange and a user
        ...
        protected override void InsertItem(int index, DateTime item)
        {
            ...
            if (!Contains(item))
            {
                ...
                if (CheckSelectionMode())
                {
                    ...
                    {
                        throw new ArgumentOutOfRangeException(Resources.Calendar_OnSelectedDateChanged_InvalidValue);
                    }
                }
            }
        }
        ...
        private bool CheckSelectionMode()
        {
            ...
            {
                throw new InvalidOperationException(Resources.Calendar_OnSelectedDateChanged_InvalidOperation);
            }
            if (_owner.SelectionMode == CalendarSelectionMode.SingleDate && Count > 0)
            {
                throw new InvalidOperationException(Resources.Calendar_CheckSelectionMode_InvalidOperation);
            }
