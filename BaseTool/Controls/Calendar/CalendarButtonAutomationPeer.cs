...
namespace BaseTool
{
    ...
    {
        /// <summary>
        /// Gets the BaseTool.Primitives.CalendarButton  to associate with this AutomationPeer.
        /// </summary>
        private Primitives.CalendarButton  OwningCalendarButton
        {
            get { return Owner as Primitives.CalendarButton;  }
        }
        ...
        /// </param>
        public CalendarButtonAutomationPeer(Primitives.CalendarButton  owner)
            : base(owner)
        {
        }        
        ...
        /// <summary>
        /// Returns the control type for the BaseTool.Primitives.CalendarButton  that is associated
        ...
        {
            return Resources.CalendarAutomationPeer_CalendarButtonLocalizedControlType;
        }

        /// <summary>
        /// Returns the string that describes the functionality of the
        /// BaseTool.Primitives.CalendarButton  that is associated with this
        ...
        {
            var  button = OwningCalendarButton;
            if (button != null && button.DataContext != null && button.DataContext is DateTime)
            {
                var dataContext = (DateTime)OwningCalendarButton.DataContext;
        ...
        /// <summary>
        /// Returns the name of the BaseTool.Primitives.CalendarButton  that is associated with this
        ...
        /// <summary>
        /// Returns the text label of the BaseTool.Primitives.CalendarButton  that is associated with
        ...
        void ISelectionItemProvider.Select()
        {
            ...
            {
                foreach (Primitives.CalendarButton  child in calendar.MonthControl.YearView.Children)
                {
