...
namespace  BaseTool
{
    ...
    /// <remarks>
    /// <para>
    /// A BaseTool.Calendar control can be used on its own, or as a drop-down part of a
    /// BaseTool.DatePicker control. For more information, see DatePicker.  A Calendar
    ...
    /// </para>
    /// <para>
    /// The BaseTool.Calendar control provides basic navigation using either the mouse or
    ...
    /// events that show a XAML usage in the reference for the BaseTool.Calendar members
    ...
    [TemplatePart(Name = ElementMonth, Type = typeof(Primitives.CalendarItem))]
    ...
    [StyleTypedProperty(Property = "CalendarButtonStyle", StyleTargetType = typeof(Primitives.CalendarButton) )]
    [StyleTypedProperty(Property = "CalendarDayButtonStyle", StyleTargetType = typeof(Primitives.CalendarDayButton  ))]
    [StyleTypedProperty(Property = "CalendarItemStyle", StyleTargetType = typeof(Primitives.CalendarItem))]
    public partial class Calendar : Control
    {
        ...
        //每季度列
        internal const int ColumnsPerQuarter = 2;
        //每季度行
        internal const int RowsPerQuarter = 2;
        ...
        /// </summary>
        internal Primitives.CalendarItem MonthControl
        {
            get
            {
                if (Root != null && Root.Children.Count > 0)
                {
                    return Root.Children[0] as Primitives.CalendarItem;
                }
                return null;
            }
        }
        ...
        /// Gets or sets Inherited code: Requires comment.
        /// </summary>
        internal Primitives.CalendarDayButton  FocusButton { get; set; }

        /// <summary>
        /// Gets or sets Inherited code: Requires comment.
        /// </summary>
        internal Primitives.CalendarButton  FocusCalendarButton { get; set; }
        ...
        private static void OnCalendarButtonStyleChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            {
                var monthControl = c.MonthControl;

                if (monthControl != null && monthControl.YearView != null)
                {
                    foreach (var child in monthControl.YearView.Children)
                    {
                        var  calendarButton = child as Primitives.CalendarButton; 
        ...
        private static void EnsureCalendarButtonStyle(Primitives.CalendarButton  calendarButton, Style oldCalendarButtonStyle, Style newCalendarButtonStyle)
        {
            ...
            if (newCalendarButtonStyle != null)
            {
                ...
                // Apply the newCalendarButtonStyle if the BaseTool.Primitives.CalendarButton  was
        ...
        private static void OnCalendarDayButtonStyleChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (newStyle != null && c != null)
            {
                ...
                {
                    foreach (var child in monthControl.MonthView.Children)
                    {
                        var  dayButton = child as Primitives.CalendarDayButton;
        ...
        private static void EnsureDayButtonStyle(Primitives.CalendarDayButton   dayButton, Style oldDayButtonStyle, Style newDayButtonStyle)
        {
        ...
        private static void EnsureMonthStyle(Primitives.CalendarItem month, Style oldMonthStyle, Style newMonthStyle)
        {
        ...
        /// </summary>
        /// <param name="d">
        /// BaseTool.Calendar that changed its IsTodayHighlighted.
        /// </param>
        ...
        private static void OnIsTodayHighlightedChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            {
                var i = DateTimeHelper.CompareYearMonth(c.DisplayDateInternal, DateTime.Today);
            ...
            var monthControl = c.MonthControl;
                ...
                if (!c.IsHandlerSuspended(DisplayModeProperty))
                {
                        ...
                        if (monthControl != null)
                        {
                            switch (oldMode)
                            {
                                ...
                                case CalendarMode.Quarter:
                                    {
                                        c.DisplayDate = c.SelectedQuarter;
                                        c.SelectedMonth = c.SelectedQuarter;
                                        break;
                                    }
                            }
                            ...
                            switch (mode)
                            {
                                //case BaseTool.CalendarMode.Quarter:
                                    
                                case CalendarMode.Month:
                                    {
                                        if (oldMode == CalendarMode.Quarter)
                                        {
                                        }
                                        else
                                        {
                    ...
                    else
                    {
                        ...
                        throw new ArgumentOutOfRangeException("d", BaseTool.Resources.Calendar_OnDisplayModePropertyChanged_InvalidValue);
                    }
                }
        ...
        {
            var handler = DisplayModeChanged;
        ...
        private static void OnFirstDayOfWeekChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            {
                throw new ArgumentOutOfRangeException("d", BaseTool.Resources.Calendar_OnFirstDayOfWeekChanged_InvalidValue);
            }
        }
        ...
        /// <remarks>
        /// <para>
        /// This property determines whether the BaseTool.Calendar allows no selection,
        ...
        private static void OnSelectionModeChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            {
                throw new ArgumentOutOfRangeException("d", BaseTool.Resources.Calendar_OnSelectionModeChanged_InvalidValue);
            }
        }
        ...
        private static void OnSelectedDateChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!c.IsHandlerSuspended(SelectedDateProperty))
            {
                if (c.SelectionMode != CalendarSelectionMode.None)
                {
                    ...
                    {
                        throw new ArgumentOutOfRangeException("d", BaseTool.Resources.Calendar_OnSelectedDateChanged_InvalidValue);
                    }
                }
                else
                {
                    throw new InvalidOperationException(BaseTool.Resources.Calendar_OnSelectedDateChanged_InvalidOperation);
                }
            }
        }
        ...
        internal void OnSelectedDatesCollectionChanged(SelectionChangedEventArgs e)
        {
            ...
            {
                var handler = SelectedDatesChanged;
                ...
                {
                    var peer = FrameworkElementAutomationPeer.FromElement(this) as CalendarAutomationPeer;
                    if (peer != null)
                    {
        ...
        private DateTime _selectedQuarter;

        /// <summary>
        /// Gets or sets Inherited code: Requires comment.
        /// </summary>
        internal DateTime SelectedQuarter
        {
            ...
            set
            {
                ...
                if (monthDifferenceStart >= 0 && monthDifferenceEnd <= 0)
                {
                    _selectedQuarter = DateTimeHelper.DiscardDayTime(value);
                }
                else
                {
                    if (monthDifferenceStart < 0)
                    {
                        _selectedQuarter = DateTimeHelper.DiscardDayTime(DisplayDateRangeStart);
                    }
                    else
                    {
                        Debug.Assert(monthDifferenceEnd > 0, "monthDifferenceEnd should be greater than 0!");
                        _selectedQuarter = DateTimeHelper.DiscardDayTime(DisplayDateRangeEnd);
                    }
                }
            }
        }
        ...
        {
            var handler = DisplayDateChanged;
            if (null != handler)
            {
                handler(this, e);
            }
        ...
        private static void OnDisplayDateStartChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!c.IsHandlerSuspended(DisplayDateStartProperty))
            {
                ...
                if (newValue.HasValue)
                {
                    ...
                    var selectedDateMin = SelectedDateMin(c);
        ...
        private static void OnDisplayDateEndChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!c.IsHandlerSuspended(DisplayDateEndProperty))
            {
                ...
                if (newValue.HasValue)
                {
                    ...
                    var selectedDateMax = SelectedDateMax(c);
        ...
        /// <summary>
        /// Gets or sets a value indicating whether BaseTool.DatePicker should change its 
        ...
        public override void OnApplyTemplate()
        {
            ...
            if (Root != null)
            {
                var month = GetTemplateChild(ElementMonth) as Primitives.CalendarItem;
        ...
        {
            Primitives.CalendarDayButton  d;
            ...
            if (monthControl != null)
            {
                if (monthControl.MonthView != null)
                {
                    ...
                    {
                        d = monthControl.MonthView.Children[childIndex] as Primitives.CalendarDayButton;
        ...
        /// <returns>Inherited code: Requires comment 2.</returns>
        internal Primitives.CalendarDayButton  FindDayButtonFromDay(DateTime day)
        {
            Primitives.CalendarDayButton  b;
            DateTime? d;
            var monthControl = MonthControl;
            ...
            if (monthControl != null)
            {
                if (monthControl.MonthView != null)
                {
                    for (var childIndex = ColumnsPerMonth; childIndex < count; childIndex++)
                    {
                        b = monthControl.MonthView.Children[childIndex] as Primitives.CalendarDayButton;
        ...
        internal void UpdateMonths()
        {
                ...
                if (monthControl != null)
                {
                    switch (DisplayMode)
                    {
                        ...
                        case CalendarMode.Year:
                            {
                                if (Dateformat == DatePickerFormat.Season)
                                {
                                   
                                    monthControl.UpdateYearMode(true);
                                }
                                else
                                {
                                    monthControl.UpdateYearMode(false);
                                }
                                break;
                            }
                        case CalendarMode.Quarter: //加上季度显示由这里进去改
                            {
                                monthControl.UpdateYearMode(true);
                                break;
                            }
        ...
        internal void HighlightDays()
        {
            if (HoverEnd != null && HoverStart != null)
            {
                ...
                if (HoverEndIndex != null && HoverStartIndex != null)
                {
                    ...
                    {
                        b = monthControl.MonthView.Children[i] as Primitives.CalendarDayButton;
                        b.IsSelected = true;
                        d = b.DataContext as DateTime?;
            ...
            if (HoverEnd != null && HoverStart != null)
            {
                ...
                if (HoverEndIndex != null && HoverStartIndex != null)
                {
                    ...
                    else
                    {
                        ...
                        for (i = startIndex; i <= endIndex; i++)
                        {
                            (monthControl.MonthView.Children[i] as Primitives.CalendarDayButton).IsSelected = false;
                        }
                    }
                }
            }
        ...
        internal void OnHeaderClick()
        {
            ...
            var monthControl = MonthControl;
            if (monthControl != null && monthControl.MonthView != null && monthControl.YearView != null&&monthControl.QuarterView!=null)
            {
                monthControl.MonthView.Visibility = Visibility.Collapsed;
                monthControl.QuarterView.Visibility = Visibility.Collapsed;
        ...
        internal void OnNextClick()
        {
            ...
            else if (DisplayMode == CalendarMode.Quarter && DisplayDate != null)
            {
        ...
        {
            if (DisplayMode != CalendarMode.Month && DisplayMode != CalendarMode.Quarter)
            {
        ...
        private void OnMonthClick()
        {
            ...
            if (monthControl != null && monthControl.YearView != null && monthControl.MonthView != null)
            {
                ...
                //if (DisplayMode == BaseTool.CalendarMode.Quarter)
                //{
                //    monthControl.MonthView.Visibility = Visibility.Collapsed;
                //    monthControl.QuarterView.Visibility = Visibility.Visible;
                //}
                //else
                //{
                //    monthControl.MonthView.Visibility = Visibility.Visible;
        ...
        internal bool ProcessCalendarKey(KeyEventArgs e)
        {
            ...
            var invariantKey = InteractionHelper.GetLogicalKey(FlowDirection, e.Key);
                ...
                case CalendarMode.Month:
                    {
                        ...
                        {
                            var selectedDate = DateTimeHelper.AddDays(LastSelectedDate.GetValueOrDefault(DateTime.Today), -ColumnsPerMonth);
        ...
        internal void YearViewHide(bool isHide)
        {
            if (MonthControl != null)
            {
                MonthControl.YearViewHide(isHide);
            }
        }
