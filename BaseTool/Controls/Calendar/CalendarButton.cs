...
namespace  BaseTool.Primitives
{
    ...
    public sealed class CalendarButton : Button
    {
        ...
        /// one has not been created for the BaseTool.Primitives.CalendarButton;  otherwise, it
        ...
        protected override void OnMouseLeftButtonDown(MouseButtonEventArgs e)
        {
            ...
            var handler = CalendarButtonMouseDown;
            if (null != handler)
            {
                handler(this, e);
            }
        ...
        protected override void OnMouseLeftButtonUp(MouseButtonEventArgs e)
        {
            ...
            var handler = CalendarButtonMouseUp;
            if (null != handler)
            {
                handler(this, e);
            }
        ...
        /// BaseTool.Primitives.CalendarButton  that stays in Pressed state after MouseCapture is
