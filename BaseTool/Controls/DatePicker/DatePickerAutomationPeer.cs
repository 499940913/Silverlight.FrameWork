...
namespace BaseTool
{
        ...
        IValueProvider
    {
        ...
        {
            get { return Owner as DatePicker; }
        }
        ...
        {
            return Resources.DatePickerAutomationPeer_LocalizedControlType;
        }
        ...
        protected override string GetNameCore()
        {
            ...
            {
                var labeledByCore = GetLabeledByCore();
                ...
                if (string.IsNullOrEmpty(nameCore))
                {
                    nameCore = OwningDatePicker.ToString();
                }
            }
            return nameCore;
        }
        ...
        string IValueProvider.Value { get { return OwningDatePicker.ToString(); } }
