    ...
    public sealed partial class DatePickerTextBox : TextBox
    {
            ...
            where T : DependencyObject
        {
            Debug.Assert(
                ...
                string.Format(CultureInfo.InvariantCulture, BaseTool.Resources.DatePickerTextBox_TemplatePartIsOfIncorrectType, partName, typeof(T).Name));
            return obj as T;
        }
        ...
        private void OnWatermarkChanged()
        {
            ...
            {
                var watermarkControl = Watermark as Control;
        ...
        {
            IsEnabled = true;
            Watermark = BaseTool.Resources.DatePickerTextBox_DefaultWatermarkText;
        }
    }
}