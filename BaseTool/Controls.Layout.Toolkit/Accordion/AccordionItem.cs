...
namespace BaseTool
{
    ...
    public class AccordionItem : HeaderedContentControl, IUpdateVisualState
    {
        ...
        /// </summary>
        public  ExpandableContentControl ExpandSite
        {
            get
            {
                return _expandSite;
        ...
        private static void OnExpandDirectionPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!ctrl._allowedToWriteExpandDirection)
            {
                ...
                var message = string.Format(
                    ...
                    BaseTool.Resources.AccordionItem_InvalidWriteToExpandDirection,
                    newValue);
                ...
                newValue != ExpandDirection.Up)
            {
                ...
                var message = string.Format(
                    CultureInfo.InvariantCulture,
                    BaseTool.Resources.Expander_OnExpandDirectionPropertyChanged_InvalidValue,
                    newValue);
        ...
        private static void OnIsSelectedPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (ctrl.IsLocked && ctrl._isSelectedNestedLevel == 0)
            {
                ...
                ctrl._isSelectedNestedLevel--;
                throw new InvalidOperationException(BaseTool.Resources.AccordionItem_OnIsSelectedPropertyChanged_InvalidChange);
            }

            if (ctrl._isSelectedNestedLevel == 0)
            {
                var parent = ctrl.ParentAccordion;
                if (parent != null)
                {
                    if (isSelected)
                    {
        ...
        private static void OnContentTargetSizePropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!source._allowedToWriteContentTargetSize)
            {
                ...
                throw new InvalidOperationException(BaseTool.Resources.AccordionItem_InvalidWriteToContentTargetSize);
            }

            // Pass the value to the expandSite
            // This is done explicitly so an animation action can be scheduled
            // deterministicly.
            var expandSite = source.ExpandSite;
        ...
        public void Schedule(AccordionAction action)
        {
            ...
            {
                var directExecute = ParentAccordion.ScheduleAction(this, action);
                if (directExecute)
                {
                    StartAction();
                }
        ...
        internal virtual void StartAction()
        {
            ...
            {
                throw new InvalidOperationException(BaseTool.Resources.AccordionItem_StartAction_InvalidCall);
            }
            Action layoutAction;
                ...
                default:
                    {
                        var message = string.Format(
                            CultureInfo.InvariantCulture,
                            BaseTool.Resources.AccordionItem_StartAction_InvalidAction,
                            ScheduledAction);
