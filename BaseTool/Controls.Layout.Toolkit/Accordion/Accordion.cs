    ...
    public class Accordion : ItemsControl, IUpdateVisualState
    {
        ...
        private static void OnExpandDirectionPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
                ...
                expandDirection != ExpandDirection.Right)
            {
                ...
                var message = string.Format(
                    ...
                    BaseTool.Resources.Accordion_OnExpandDirectionPropertyChanged_InvalidValue,
                    expandDirection);
        ...
        private static void OnSelectionModePropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
                ...
                newValue != AccordionSelectionMode.ZeroOrOne)
            {
                ...
                var message = string.Format(
                    CultureInfo.InvariantCulture,
                    BaseTool.Resources.Accordion_OnSelectionModePropertyChanged_InvalidValue,
                    newValue);
                throw new ArgumentOutOfRangeException("e", message);
            }
            ...
            if (source.IsMaximumOneSelected)
            {
                ...
                if (source.SelectedIndices.Count > 1)
                {
                    ...
                    var indices = source.SelectedIndices.ToList();
        ...
        private static void OnSelectedItemPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            var newValues = newValue == null ? new object[0] : new[] { newValue };
            var oldValues = oldValue == null ? new object[0] : new[] { oldValue };
            ...
            else if (source._selectedItemNestedLevel == 0)
            {
                ...
                else
                {
                    ...
                    var currentIndex = source.SelectedIndex;
                    ...
                    if (currentIndex < 0 || currentIndex > source.Items.Count || !newValue.Equals(source.Items[currentIndex]))
                    {
                        ...
                        var validIndices = source.SelectedIndices.Where(i => i >= 0 && i < source.Items.Count && newValue.Equals(source.Items[i]));
        ...
        private static void OnSelectionSequencePropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
                ...
                newValue != SelectionSequence.Simultaneous)
            {
                ...
                var message = string.Format(
                    CultureInfo.InvariantCulture,
                    BaseTool.Resources.Accordion_OnSelectionSequencepropertyChanged_InvalidValue,
                    newValue);
                throw new ArgumentOutOfRangeException("e", message);
            }
        }
        ...
        private static void OnSelectedItemsChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!accordion._isAllowedToWriteSelectedItems)
            {
                ...
                throw new InvalidOperationException(BaseTool.Resources.Accordion_OnSelectedItemsChanged_InvalidWrite);
            }
        }
        ...
        private static void OnSelectedIndicesChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!accordion._isAllowedToWriteSelectedIndices)
            {
                ...
                throw new InvalidOperationException(BaseTool.Resources.Accordion_OnSelectedIndicesChanged_InvalidWrite);
            }
        }
        ...
        protected override void PrepareContainerForItemOverride(DependencyObject element, object item)
        {
            ...
            if (accordionItem != null)
            {
                var specifiedContentTemplate = accordionItem.ContentTemplate;
                ...
                var displayMemberTemplate = accordionItem.ContentTemplate;
                ...
                var index = ItemContainerGenerator.IndexFromContainer(accordionItem);
        ...
        private void UnselectItem(int index, object item)
        {
            ...
            var container = index >= 0 && index < Items.Count ? ItemContainerGenerator.ContainerFromIndex(index) as AccordionItem : null;
            ...
            if (SelectedItems.OfType<object>().Contains(item) && index != newSelectedIndex && !item.Equals(SelectedItem))
            {
                ...
                if (SelectedIndices.Count(i => i != index && i < Items.Count && Items[i].Equals(item)) == 0)
                {
                    ...
                    {
                        throw new InvalidOperationException(BaseTool.Resources.Accordion_InvalidManipulationOfSelectionCollections);
                    }
                    SelectedItems.Remove(item);
                }
            }
        ...
        {
            var oldAccordionItem = oldIndex >= 0 && oldIndex < Items.Count ? ItemContainerGenerator.ContainerFromIndex(oldIndex) as AccordionItem : null;
            var newAccordionItem = newIndex >= 0 && newIndex < Items.Count ? ItemContainerGenerator.ContainerFromIndex(newIndex) as AccordionItem : null;
            ...
            Action<object> unselectItem = item =>
                                              {
                                                      ...
                                                      var valid = SelectedIndices.Where(i => i < Items.Count && item.Equals(Items[i])).ToList();
                                                      if (valid.Count > 0)
                                                      {
                ...
                case NotifyCollectionChangedAction.Reset:
                    {
                        ...
                        for (var i = SelectedIndices.Count - 1; i >= 0; i--)
                        {
                            ...
                            {
                                var tempItem = Items[selectedIndex];
                                unselectItem(tempItem);
                            }
                        }
                    }
                ...
                default:
                    {
                        var message = string.Format(
                                CultureInfo.InvariantCulture,
                                BaseTool.Resources.Accordion_UnsupportedCollectionAction,
                                e.Action);
        ...
        private int ProposeSelectedIndexCandidate(int nonCandidateIndex)
        {
            ...
            var item = nonCandidateIndex >= 0 && nonCandidateIndex < Items.Count ? Items[nonCandidateIndex] : null;

            // see if we can find a suitable item in the selecteditems collection
            var validIndices = SelectedIndices.Where(i => i != nonCandidateIndex && (item == null || !item.Equals(Items[i])));
        ...
        internal virtual void OnActionFinish(AccordionItem item)
        {
            if (SelectionSequence == SelectionSequence.CollapseBeforeExpand)
            {
                lock (this)
                {
                    ...
                    {
                        throw new InvalidOperationException(BaseTool.Resources.Accordion_OnActionFinish_InvalidFinish);
                    }
        ...
        private void StartNextAction()
        {
            ...
            var next = _scheduledActions.FirstOrDefault(item => item.ScheduledAction == AccordionAction.Collapse);
            if (next == null)
            {
        ...
        {
            var root = ItemsControlHelper.ScrollHost;
            ...
            if (root != null && ItemsControlHelper.ItemsHost != null)
            {
                if (IsShouldFillWidth)
                {
                    ...
                    // was made smaller.
                    var smaller = root.ViewportWidth - ItemsControlHelper.ItemsHost.ActualWidth;
                ...
                else if (IsShouldFillHeight)
                {
                    ...
                    // offset for the real difference in viewportheight and actualheight. This happens when accordion
                    // was made smaller.
                    var smaller = root.ViewportHeight - ItemsControlHelper.ItemsHost.ActualHeight;
