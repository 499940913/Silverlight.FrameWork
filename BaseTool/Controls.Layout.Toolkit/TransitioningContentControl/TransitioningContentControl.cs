    ...
    public class TransitioningContentControl : ContentControl
    {
        ...
        private static void OnIsTransitioningPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!source._allowIsTransitioningWrite)
            {
                ...
                throw new InvalidOperationException(BaseTool.Resources.TransitiotioningContentControl_IsTransitioningReadOnly);
            }
        }
            ...
            if (newStoryboard == null)
            {
                ...
                else
                {
                    ...
                    throw new ArgumentException(
                        string.Format(CultureInfo.CurrentCulture, BaseTool.Resources.TransitioningContentControl_TransitionNotFound, newTransition));
                }
            }
            else
            {
        ...
        public override void OnApplyTemplate()
        {
            ...
            if (transition == null)
            {
                ...
                throw new ArgumentException(
                    string.Format(CultureInfo.CurrentCulture, BaseTool.Resources.TransitioningContentControl_TransitionNotFound, invalidTransition));
            }
